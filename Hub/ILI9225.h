 ...
 *      Author: User
 *
 *  Sourced from https://github.com/BasicCode/ILI9225
 */
...
//#define LED_GPIO_Port GPIOF
	#define	CSX_PORT	CS_GPIO_Port//GPIOA//CS_GPIO_Port
    #define CSX_PIN		CS_Pin//GPIO_PIN_4//CS_Pin //Chip select
	#define RESX_PORT	RST_GPIO_Port//GPIOF//RST_GPIO_Port
    #define RESX_PIN	RST_Pin//GPIO_PIN_13//RST_Pin //Reset pin
	#define	CMD_PORT	RS_GPIO_Port//GPIOF//RS_GPIO_Port
    #define CMD_PIN		RS_Pin//GPIO_PIN_12//RS_Pin //Command select

    //SPI Bus status register
    //Set this to suit your particular microcontroller
//	SPI_HandleTypeDef *hspi_ptr;

	void init_hspi(SPI_HandleTypeDef *hspi);
