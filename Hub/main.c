...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, Col_3_Pin|Col_2_Pin|Col_4_Pin|RS_Pin
                          |RST_Pin|LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Col_3_Pin Col_2_Pin Col_4_Pin RS_Pin
                           RST_Pin LED_Pin */
  GPIO_InitStruct.Pin = Col_3_Pin|Col_2_Pin|Col_4_Pin|RS_Pin
                          |RST_Pin|LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
